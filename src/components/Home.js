                ...
                <div className="row gx-5 align-items-center sm-4">
                    ...
                    <div className="col-lg-6 order-lg-1 sm-2">
                        <div className="p-5">
                            ...
                            <p className="newsm">mixture of substances intended for preventing, destroying, repelling, or mitigating any pest.Any substance or mixture of substances intended for use as a plant regulator, defoliant, or desiccant.
